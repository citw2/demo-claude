#!/usr/bin/env node
// SAIHM memory for Claude — one client-side-encrypted memory you own; provable forget.
//
//   git clone https://github.com/citw2/demo-claude
//   cd demo-claude && npm install && node demo.mjs
//
// Optional, for a LIVE Claude answer instead of the offline mock:
